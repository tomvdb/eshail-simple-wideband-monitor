...
function isScrollParent(e) {
    var t = getComputedStyle(e), n = t.overflow, r = t.overflowX, o = t.overflowY;
    return /auto|scroll|overlay|hidden/.test(n + o + r)
}

function getCompositeRect(e, t, n) {
    void 0 === n && (n = !1);
    var r = getDocumentElement(t), o = getBoundingClientRect(e), i = isHTMLElement(t),
        a = {scrollLeft: 0, scrollTop: 0}, s = {x: 0, y: 0};
...
function listScrollParents(e, t) {
    void 0 === t && (t = []);
    var n = getScrollParent(e), r = "body" === getNodeName(n), o = getWindow(n),
        i = r ? [o].concat(o.visualViewport || [], isScrollParent(n) ? n : []) : n, a = t.concat(i);
...
var top = "top", bottom = "bottom", right = "right", left = "left", auto = "auto",
    basePlacements = [top, bottom, right, left], start = "start", end = "end", clippingParents = "clippingParents",
    viewport = "viewport", popper = "popper", reference = "reference",
    ...
    }, []), beforeRead = "beforeRead", read = "read", afterRead = "afterRead", beforeMain = "beforeMain", main = "main",
    afterMain = "afterMain", beforeWrite = "beforeWrite", write = "write", afterWrite = "afterWrite",
    modifierPhases = [beforeRead, read, afterRead, beforeMain, main, afterMain, beforeWrite, write, afterWrite];

function order(e) {
    var r = new Map, o = new Set, t = [];
...
function getViewportRect(e) {
    var t = getWindow(e), n = getDocumentElement(e), r = t.visualViewport, o = n.clientWidth, i = n.clientHeight, a = 0,
        s = 0;
...
function getDocumentRect(e) {
    var t = getDocumentElement(e), n = getWindowScroll(e), r = e.ownerDocument.body,
        ...
        a = -n.scrollLeft + getWindowScrollBarX(e), s = -n.scrollTop;
...
function getClippingRect(r, e, t) {
    var n = "clippingParents" === e ? getClippingParents(r) : [].concat(e), o = [].concat(n, [t]), i = o[0],
...
function computeOffsets(e) {
    var t, n = e.reference, r = e.element, o = e.placement, i = o ? getBasePlacement(o) : null,
        a = o ? getVariation(o) : null, s = n.x + n.width / 2 - r.width / 2, c = n.y + n.height / 2 - r.height / 2;
    switch (i) {
        case top:
...
function detectOverflow(e, t) {
    void 0 === t && (t = {});
    var r, n = t.placement, o = void 0 === n ? e.placement : n, i = t.boundary, a = void 0 === i ? clippingParents : i,
        s = t.rootBoundary, c = void 0 === s ? viewport : s, p = t.elementContext, l = void 0 === p ? popper : p,
        f = t.altBoundary, d = void 0 !== f && f, u = t.padding, m = void 0 === u ? 0 : u,
        g = mergePaddingObject("number" != typeof m ? m : expandToHashMap(m, basePlacements)),
        h = l === popper ? reference : popper, b = e.elements.reference, v = e.rects.popper, y = e.elements[d ? h : l],
        O = getClippingRect(isElement(y) ? y : y.contextElement || getDocumentElement(e.elements.popper), a, c),
        w = getBoundingClientRect(b),
        E = computeOffsets({reference: w, element: v, strategy: "absolute", placement: o}),
        P = rectToClientRect(Object.assign(Object.assign({}, v), E)), x = l === popper ? P : w, S = {
...
function popperGenerator(e) {
    void 0 === e && (e = {});
    var t = e.defaultModifiers, s = void 0 === t ? [] : t, n = e.defaultOptions, c = void 0 === n ? DEFAULT_OPTIONS : n;
        ...
        var l = {
            ...
            state: l, setOptions: function (e) {
                ...
                return l.orderedModifiers = n.filter(function (e) {
                    ...
                    var t, n = e.name, r = e.options, o = void 0 === r ? {} : r, i = e.effect;
...
function effect(e) {
    var t = e.state, n = e.instance, r = e.options, o = r.scroll, i = void 0 === o || o, a = r.resize,
        s = void 0 === a || a, c = getWindow(t.elements.popper),
...
function mapToStyles(e) {
    var t, n, r = e.popper, o = e.popperRect, i = e.placement, a = e.offsets, s = e.position, c = e.gpuAcceleration,
        p = e.adaptive, l = roundOffsets(a), f = l.x, d = l.y, u = a.hasOwnProperty("x"), m = a.hasOwnProperty("y"),
        g = left, h = top, b = window;
    ...
    var v, y = Object.assign({position: s}, p && unsetSides);
...
function computeStyles(e) {
    var t, n = e.state, r = e.options, o = r.gpuAcceleration, i = void 0 === o || o, a = r.adaptive,
        s = void 0 === a || a;
    ...
    null != n.modifiersData.popperOffsets && (n.styles.popper = Object.assign(Object.assign({}, n.styles.popper), mapToStyles(Object.assign(Object.assign({}, c), {}, {
        ...
        position: "absolute",
        adaptive: !1
    })))), n.attributes.popper = Object.assign(Object.assign({}, n.attributes.popper), {}, {"data-popper-placement": n.placement})
}
...
function applyStyles(e) {
    ...
    Object.keys(o.elements).forEach(function (e) {
        var t = o.styles[e] || {}, n = o.attributes[e] || {}, r = o.elements[e];
...
function effect$1(e) {
    ...
    return Object.assign(o.elements.popper.style, i.popper), o.elements.arrow && Object.assign(o.elements.arrow.style, i.arrow), function () {
        Object.keys(o.elements).forEach(function (e) {
...
function distanceAndSkiddingToXY(e, t, n) {
    var r = getBasePlacement(e), o = 0 <= [left, top].indexOf(r) ? -1 : 1,
        i = "function" == typeof n ? n(Object.assign(Object.assign({}, t), {}, {placement: e})) : n,
        a = (a = i[0]) || 0, s = ((s = i[1]) || 0) * o;
    return 0 <= [left, right].indexOf(r) ? {x: s, y: a} : {x: a, y: s}
}

function offset(e) {
    var n = e.state, t = e.options, r = e.name, o = t.offset, i = void 0 === o ? [0, 0] : o,
        a = placements.reduce(function (e, t) {
            return e[t] = distanceAndSkiddingToXY(t, n.rects, i), e
        }, {}), s = a[n.placement], c = s.x, p = s.y;
...
function computeAutoPlacement(n, e) {
    void 0 === e && (e = {});
    var t = e.placement, r = e.boundary, o = e.rootBoundary, i = e.padding, a = e.flipVariations,
        s = e.allowedAutoPlacements, c = void 0 === s ? placements : s, p = getVariation(t),
        l = p ? a ? variationPlacements : variationPlacements.filter(function (e) {
            return getVariation(e) === p
        }) : basePlacements, f = l.filter(function (e) {
...
function flip(e) {
    ...
    if (!n.modifiersData[r]._skip) {
        for (var o = t.mainAxis, i = void 0 === o || o, a = t.altAxis, s = void 0 === a || a, c = t.fallbackPlacements, p = t.padding, l = t.boundary, f = t.rootBoundary, d = t.altBoundary, u = t.flipVariations, m = void 0 === u || u, g = t.allowedAutoPlacements, h = n.options.placement, b = getBasePlacement(h), v = c || (b === h || !m ? [getOppositePlacement(h)] : getExpandedFallbackPlacements(h)), y = [h].concat(v).reduce(function (e, t) {
            ...
            var R = y[S], M = getBasePlacement(R), N = getVariation(R) === start, D = 0 <= [top, bottom].indexOf(M),
                j = D ? "width" : "height",
                T = detectOverflow(n, {placement: R, boundary: l, rootBoundary: f, altBoundary: d, padding: p}),
                I = D ? N ? right : left : N ? bottom : top;
            O[j] > w[j] && (I = getOppositePlacement(I));
            var L = getOppositePlacement(I), C = [];
...
function preventOverflow(e) {
    var t, n, r, o, i, a, s, c, p, l, f, d, u, m, g, h, b, v, y, O, w, E, P, x, S, R, M, N = e.state, D = e.options,
        j = e.name, T = D.mainAxis, I = void 0 === T || T, L = D.altAxis, C = void 0 !== L && L, A = D.boundary,
        B = D.rootBoundary, _ = D.altBoundary, V = D.padding, W = D.tether, k = void 0 === W || W, F = D.tetherOffset,
        H = void 0 === F ? 0 : F, q = detectOverflow(N, {boundary: A, rootBoundary: B, padding: V, altBoundary: _}),
        $ = getBasePlacement(N.placement), G = getVariation(N.placement), U = !G, X = getMainAxisFromPlacement($),
        Y = getAltAxis(X), z = N.modifiersData.popperOffsets, J = N.rects.reference, K = N.rects.popper,
        Q = "function" == typeof H ? H(Object.assign(Object.assign({}, N.rects), {}, {placement: N.placement})) : H,
        Z = {x: 0, y: 0};
...
function arrow(e) {
    var t, n, r, o, i, a, s, c, p, l, f, d, u, m, g = e.state, h = e.name, b = g.elements.arrow,
        v = g.modifiersData.popperOffsets, y = getBasePlacement(g.placement), O = getMainAxisFromPlacement(y),
...
function effect$2(e) {
    var t = e.state, n = e.options, r = e.name, o = n.element, i = void 0 === o ? "[data-popper-arrow]" : o,
        a = n.padding, s = void 0 === a ? 0 : a;
    null != i && ("string" == typeof i && !(i = t.elements.popper.querySelector(i)) || ("production" !== process.env.NODE_ENV && (isHTMLElement(i) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))), contains(t.elements.popper, i) ? (t.elements.arrow = i, t.modifiersData[r + "#persistent"] = {padding: mergePaddingObject("number" != typeof s ? s : expandToHashMap(s, basePlacements))}) : "production" !== process.env.NODE_ENV && console.error(['Popper: "arrow" modifier\'s `element` must be a child of the popper', "element."].join(" "))))
}
...
function hide(e) {
    var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow,
        a = detectOverflow(t, {elementContext: "reference"}), s = detectOverflow(t, {altBoundary: !0}),
        c = getSideOffsets(a, r), p = getSideOffsets(s, o, i), l = isAnySideFullyClipped(c),
